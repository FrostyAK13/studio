        ...
        setTimeout(() => {
            ...
            switch (targetStrategy) {
                case 'even-odd':
                    ...
                    reasoning = `The market is exhibiting a heavy ${evenPerc > oddPerc ? 'Even' : 'Odd'} bias. Entry is optimized for the next parity shift cycle.`;
                    break;
                case 'over-under':
                    strategy = "OVER/UNDER";
                    ...
                    reasoning = `Sequential high-density distribution identified. System confirms an imminent barrier reversion toward the ${overPerc > underPerc ? 'lower' : 'upper'} spectrum.`;
                    break;
                case 'matches-differs':
                    ...
                    confidence = 99.8;
                    reasoning = `Digit ${hottestDigit} has reached statistical saturation. Statistical variance system confirms a safe 'Differ' window for the next 15 ticks.`;
                    break;
                case 'rise-fall':
                    strategy = "RISE/FALL";
                    ...
                    confidence = 65.5;
                    reasoning = `Neural patterns indicate ${isBullish ? 'overbought' : 'oversold'} conditions. The 100+1 accuracy system identifies an immediate directional pivot.`;
                    break;
                case 'only-up-down':
                    strategy = "ONLY UP/DOWN";
                    pattern = "Sustained Strength";
                    prediction = evenPerc > 50 ? "ONLY DOWN" : "ONLY UP";
                    trigger = `Continuous 3-Tick Streak`;
                    confidence = 72.3;
        ...
        <div className="space-y-6 animate-in fade-in duration-1000 pb-24 max-w-7xl mx-auto px-2">
            <Card className="border-none shadow-sm bg-card rounded-3xl border border-primary/5">
                <CardContent className="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                    ...
                    <div className="space-y-1.5">
                        <Label className="text-[10px] font-black uppercase tracking-[0.4em] text-primary/60 ml-2">TYPE</Label>
                    ...
                    <div className="space-y-1.5">
                        <Label className="text-[10px] font-black uppercase tracking-[0.4em] text-primary/60 ml-2">TICKS</Label>
                        <Input
                            type="number"
                            value={maxTicks}
                    ...
                    <div className="space-y-1.5">
                        <Label className="text-[10px] font-black uppercase tracking-[0.4em] text-primary/60 ml-2">PRICE</Label>
            ...
            <div className="flex flex-col items-center justify-center py-12 gap-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground">100+1 ACCURACY SYSTEM ACTIVE</p>
                </div>
            </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                             <Card className="bg-card border-primary/5 shadow-sm rounded-2xl p-6">
                                <div className="flex justify-between items-start mb-3">
                                    <p className="text-[9px] font-black text-primary/60 uppercase tracking-widest">PATTERN</p>
                            ...
                            <Card className="bg-card border-primary/5 shadow-sm rounded-2xl p-6">
                                <div className="flex justify-between items-start mb-3">
                                    <p className="text-[9px] font-black text-primary/60 uppercase tracking-widest">PREDICTION</p>
                        ...
                        <Card className="bg-white border-primary/10 rounded-[2rem] p-8 relative overflow-hidden shadow-sm">
                            ...
                            <div className="flex items-start gap-8">
                                ...
                                <div className="space-y-3">
                                    <p className="text-[10px] font-black text-primary uppercase tracking-[0.4em]">SYNOPSIS</p>
