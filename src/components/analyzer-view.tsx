        ...
        return slice.map((digit, i) => {
            ...
            return (
                <motion.div 
                    ...
                    className={cn(
                        "w-10 h-10 sm:w-16 sm:h-16 rounded-full flex items-center justify-center font-black text-sm sm:text-2xl border transition-all duration-300 relative overflow-hidden",
                        isPivot ? "ring-4 ring-white ring-offset-4 ring-offset-slate-950 z-30 shadow-[0_0_40px_rgba(255,255,255,0.6)] bg-white text-black" : colorClass
                    )}
                >
